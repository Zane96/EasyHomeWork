...
public class StuSelfWork implements Parcelable {
    ...
    protected StuSelfWork(Parcel in) {
    ...
    public static final Parcelable.Creator<StuSelfWork> CREATOR = new Parcelable.Creator<StuSelfWork>() {
        @Override
        public StuSelfWork createFromParcel(Parcel source) {
            return new StuSelfWork(source);
        }

        @Override
        public StuSelfWork[] newArray(int size) {
            return new StuSelfWork[size];
        }
    };
}
