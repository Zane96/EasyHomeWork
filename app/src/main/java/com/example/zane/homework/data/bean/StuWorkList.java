...
public class StuWorkList implements Parcelable {
    ...
    protected StuWorkList(Parcel in) {
    ...
    public static final Parcelable.Creator<StuWorkList> CREATOR = new Parcelable.Creator<StuWorkList>() {
        @Override
        public StuWorkList createFromParcel(Parcel source) {
            return new StuWorkList(source);
        }

        @Override
        public StuWorkList[] newArray(int size) {
            return new StuWorkList[size];
        }
    };
}
